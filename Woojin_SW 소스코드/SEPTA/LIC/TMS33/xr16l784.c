...
void xr16l784_Send(int nChl,UCHAR *pTxBuf,int nLen)
{
	...
	case XR16L784_1CHL:
		if(!m_nXr16l784TxPos1)
		{
			...
			memcpy(m_ucXr16l784TxBuf1,pTxBuf,nLen);
		...
		{
			if(m_nXr16l784TxLen1 + nLen >= XR16L784_TXBUF_1CH_MAX) return;
			memcpy(&m_ucXr16l784TxBuf1[m_nXr16l784TxLen1],pTxBuf,nLen);
			m_nXr16l784TxLen1 += nLen;
		}
		break;
	case XR16L784_2CHL:
		if(!m_nXr16l784TxPos2)
		{
			...
			memcpy(m_ucXr16l784TxBuf2,pTxBuf,nLen);
		...
		{
			if(m_nXr16l784TxLen2 + nLen >= XR16L784_BUF_2CH_MAX) return;
			memcpy(&m_ucXr16l784TxBuf2[m_nXr16l784TxLen2],pTxBuf,nLen);
			m_nXr16l784TxLen2 += nLen;
		}
		break;
	case XR16L784_3CHL:
		if(!m_nXr16l784TxPos3)
		{
			...
			memcpy(m_ucXr16l784TxBuf3,pTxBuf,nLen);
		...
		{
			if(m_nXr16l784TxLen3 + nLen >= XR16L784_BUF_3CH_MAX) return;
			memcpy(&m_ucXr16l784TxBuf3[m_nXr16l784TxLen3],pTxBuf,nLen);
			m_nXr16l784TxLen3 += nLen;
		}
		break;
	case XR16L784_4CHL:
		if(!m_nXr16l784TxPos4)
		{
			...
			memcpy(m_ucXr16l784TxBuf4,pTxBuf,nLen);
		...
		{
			if(m_nXr16l784TxLen4 + nLen >= XR16L784_BUF_4CH_MAX) return;
			memcpy(&m_ucXr16l784TxBuf4[m_nXr16l784TxLen4],pTxBuf,nLen);
			m_nXr16l784TxLen4 += nLen;
		}
		break;
	}
...
void xr16l784_Isr()
{
	...
	if(nSt&0x02)
	{
		...
		{
			pXr16Reg->xr16Reg[XR16L784_1CHL].CREG1.btTxd = m_ucXr16l784TxBuf1[m_nXr16l784TxPos1++ % XR16L784_TXBUF_1CH_MAX];
		}
		else
		{
	...
	if(nSt&0x02)
	{
		...
		{
			pXr16Reg->xr16Reg[XR16L784_2CHL].CREG1.btTxd = m_ucXr16l784TxBuf2[m_nXr16l784TxPos2++ % XR16L784_BUF_2CH_MAX];
		}
		else
		{
	...
	if(nSt&0x02)
	{
		...
		{
			pXr16Reg->xr16Reg[XR16L784_3CHL].CREG1.btTxd = m_ucXr16l784TxBuf3[m_nXr16l784TxPos3++ % XR16L784_BUF_3CH_MAX];
		}
		else
		{
	...
	if(nSt&0x02)
	{
		...
		{
			pXr16Reg->xr16Reg[XR16L784_4CHL].CREG1.btTxd = m_ucXr16l784TxBuf4[m_nXr16l784TxPos4++ % XR16L784_BUF_4CH_MAX];
		}
		else
		{
...
void xr16l784_1msLoop()
{
	...
	if(m_nXr16l784TxStartEnableDly2 == 1) xr16l784_Send(XR16L784_2CHL,m_ucXr16l784TxBuf2Temp,m_nXr16l784TxLen2Temp);
	if(m_nXr16l784TxStartEnableDly2) m_nXr16l784TxStartEnableDly2--;
	if(m_nXr16l784TxStartEnableDly3 == 1) xr16l784_Send(XR16L784_3CHL,m_ucXr16l784TxBuf3Temp,m_nXr16l784TxLen3Temp);
	if(m_nXr16l784TxStartEnableDly3) m_nXr16l784TxStartEnableDly3--;
	if(m_nXr16l784TxStartEnableDly4 == 1) xr16l784_Send(XR16L784_4CHL,m_ucXr16l784TxBuf4Temp,m_nXr16l784TxLen4Temp);
