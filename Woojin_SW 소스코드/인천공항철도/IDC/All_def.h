...
#define LINE_ON		(*(UCHAR *)(0x814000))		// New Version
...
#define DISPLAY_STANDARD_UNIT 52	//일반 전체 
#define DISPLAY_STANDARD_UNIT_A 24	//일반 차내
#define DISPLAY_STANDARD_UNIT_B 28	//일반 노선,정면,열번
