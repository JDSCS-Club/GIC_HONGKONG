...
******************************************************
;	c:\lang\TMS320C3X\bin\ac30.exe main.c C:\DOCUME~1\ADMINI~1\LOCALS~1\Temp\main.if 
;	c:\lang\TMS320C3X\bin\cg30.exe -o -n -m -o C:\DOCUME~1\ADMINI~1\LOCALS~1\Temp\main.if C:\DOCUME~1\ADMINI~1\LOCALS~1\Temp\main.asm C:\DOCUME~1\ADMINI~1\LOCALS~1\Temp\main.tmp 
	.version	30
FP	.set		AR3
	.file	"main.c"
...
;>>>> 					if(NUM_HI!=gRxExcCode[14]&0xff||NUM_LOW!=gRxExcCode[15]&0xff)
	LDI	@_NUM_HI,R1
	CMPI	@_gRxExcCode+14,R1
	LDIU	0,R2
	LDINZ	1,R2
	TSTB	0ffh,R2
	BNZ	LL20
	LDI	@_NUM_LOW,R2
	CMPI	@_gRxExcCode+15,R2
	LDIU	0,R3
	LDINZ	1,R3
	TSTB	0ffh,R3
	BZ	L71
...
EPI0_30:
	...
	.sym	_IMAGE_DATA,_IMAGE_DATA,32,2,0
	.globl	_IMAGE_DATA

	.func	734
;>>>> 	void IMAGE_DATA(void)
******************************************************
* FUNCTION DEF : _IMAGE_DATA
******************************************************
_IMAGE_DATA:
	PUSH	FP
	LDI	SP,FP
...
EPI0_31:
	...
	SUBI	5,SP
***	B	R1	;BRANCH OCCURS
	.endfunc	745,000000000H,3
	.globl	_FULL_DATA_1
	.globl	_FULL_DATA_2
	.globl	_FULL_DATA_3
	.globl	_FULL_DATA_4
	.globl	_FULL_DATA_ALL
...
_ImageMake:
	...
	.sym	_j,2,4,1,32
	.sym	_k,3,4,1,32
	.sym	_FULL_ALL,4,4,1,32
	.sym	_ALL,5,4,1,32
	.sym	_nBitPos,6,4,1,32
	.sym	_pVd,7,28,1,32
	.line	2
	.line	3
;>>>> 		int i=0,j=0,k=0;
...
EPI0_36:
	...
	.endfunc	908,0083f07ffH,0

	.sym	_gRxBuffer,_gRxBuffer,60,2,19200,,600
	.globl	_gRxBuffer
	.bss	_gRxBuffer,600

	.sym	_FULL_DATA_1,_FULL_DATA_1,60,2,16384,,512
	.globl	_FULL_DATA_1
	.bss	_FULL_DATA_1,512

	.sym	_FULL_DATA_2,_FULL_DATA_2,60,2,16384,,512
	.globl	_FULL_DATA_2
	.bss	_FULL_DATA_2,512

	.sym	_FULL_DATA_3,_FULL_DATA_3,60,2,16384,,512
	.globl	_FULL_DATA_3
	.bss	_FULL_DATA_3,512

	.sym	_FULL_DATA_4,_FULL_DATA_4,60,2,16384,,512
	.globl	_FULL_DATA_4
	.bss	_FULL_DATA_4,512
	...
	.sym	_FULL_DATA_ALL,_FULL_DATA_ALL,60,2,16384,,512
	.globl	_FULL_DATA_ALL
	.bss	_FULL_DATA_ALL,512
...
******************************************************
	...
	.word 	0ff000000h       ;61
	.word 	0ff0000h         ;62
	.word 	_SEND_DATA_BUFF+3;63
	.word 	_nBuff           ;64
	.word 	_FULL_DATA_1     ;65
	.word 	_FULL_DATA_2     ;66
	.word 	_FULL_DATA_3     ;67
	.word 	_FULL_DATA_4     ;68
	.word 	_FULL_DATA_ALL   ;69
	.word 	2097152          ;70
	.word 	8421380          ;71
	.word 	8421382          ;72
	.word 	2293760          ;73
