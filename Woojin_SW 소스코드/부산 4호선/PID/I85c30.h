...
//#define COM_SEND(A,B,C,D,E,F,G,H,I,J) (BYTE)((COM_DAT(A,B)<<64|(COM_DAT(C,D))<<48|(COM_DAT(E,F))<<32|(COM_DAT(G,H))<<16|(COM_DAT(I,J)))
#define ASC_DAT(A,B) (BYTE)((A<<4)&0xf0|(B)&0x0f)
#define ITEM_HAP(A,B,C,D) (BYTE)((((ASC_DAT(A,B)<<8))&0xFF00)|(ASC_DAT(C,D)&0x00ff))
